...
def do_deploy(archive_path):
	...
	if isfile(archive_path):
		...
		move_files = sudo(mv_command.format(path_to_unpack, path_to_unpack))
		...
		make_symb = sudo("ln -sf {} /data/web_static/current".format(path_to_unpack))
